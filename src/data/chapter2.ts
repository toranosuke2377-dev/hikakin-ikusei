...
export const chapter2Events: StoryEvent[] = [
  ...
  event({
    ...
    location: "社員寮・自室",
    body: [
      "ゲームを起動した瞬間、ヒカキンは新しい遊びを前に子供のように笑った。楽しさは本物なのに、プレイへ集中すると言葉が完全に止まる。後から見返せば、無言の画面と突然の効果音だけが続いていた。",
      "初対面の人や大勢の前では言葉を探すヒカキンも、一人でカメラへ向かうことには慣れ始めている。それでも実況は、失敗した瞬間の声まで作品になる別の技術だ。上手く見せるより、本当に楽しむ姿をどう届けるか考えた。"
    ],
    choices: [
      choice(
