...
export const chapter3Events: StoryEvent[] = [
  ...
  ch3({
    ...
    location: "東大オンエアの地元",
    body: [
      "東大オンエアの企画会議は、温厚なテツの『まあ、やってみよう』で突然動く。静かな柴竜が一言だけ異常な案を足し、としみちがカメラ前の見せ場へ変える。丸眼鏡は予算とルールを組み、yo!!は遅れた二人を待ちながら現場を最後まで動かし、ユメマールは五人の間を笑ってつないでいた。",
      "都会のスタジオへ移れば効率は上がる。だが彼らの面白さは、六人の仲と地元の距離感から生まれている。先輩として答えを求められたヒカキンは、自分の成功法を押しつけずに全国へ届く道を考えた。"
    ],
    speaker: "テツ",
    ...
    choices: [
      ...
      choice("ch3_07_tets_roles", "六人の役割分担を一緒に整理する", [
        "ヒカキンは、テツの発想、柴竜の予測不能な一撃、としみちの表現、丸眼鏡の設計、yo!!の現場進行、ユメマールの空気作りを一本の進行表へ並べた。役割は固定せず、得意な瞬間だけ前へ出る形にする。",
        "六人を型へ押し込めず、違いが衝突しない順番だけを整えた経験から、ヒカキンも集団の魅力を編集で活かす方法を学んだ。"
      ], {
  ...
  ch3({
    ...
    body: [
      ...
      "丸眼鏡は事実関係を整理し、yo!!は次の撮影を止め、テツは動画を消す覚悟で頭を下げている。ヒカキンにも共同出演者として、再生数の恩恵だけでなく後始末を引き受ける責任がある。"
    ],
    choices: [
  ...
  ch3({
    ...
    body: [
      ...
      "駅では、進行表を持つyo!!と丸眼鏡の横で、としみちが到着だけを舞台のように盛り上げ、ユメマールが自然にヒカキンの荷物を持った。遅れて現れたテツと柴竜は、謝るより先に地元全体を使う案を話し始める。ヒカキンは、効率だけでは撮れない六人の関係を目の前で知った。"
    ],
    choices: [
      ...
      choice("ch3_07_invite_challenge", "六人対一人の企画で勝負する", [
        "地元全体を使う謎解き対決をヒカキンが提案した。丸眼鏡の推理、yo!!の根性、としみちの攪乱、ユメマールの連携、柴竜の予測不能な寄り道を、ヒカキンは一人の観察と編集で迎え撃つ。",
  ...
  ch3({
    ...
    location: "巨大アスレチック会場",
    body: [
      "徹夜で構成を詰めたヒカキンが夜明けの会場へ着くと、ショートスリーパーのシル子はすでにコースを何周も試走していた。才能だけではない努力を互いに見抜いた二人は、高所から飛び降りる案の前で初めて足を止める。",
      "安全装置は基準を満たしている。それでも、装置の見えない映像を子供が真似すれば危険だけが残る。シル子が実演できるかではなく、ヒカキンが共同制作者としてどう見せるかで撮影時間も予算も変わる。"
    ],
    speaker: "シル子",
    quote: "できるかじゃなくて、見せていいかを決めたい。",
    choices: [
      choice("ch3_08_safety_redesign", "高さを下げず、安全装置も企画として見せる", [
        "ヒカキンはザ顔の安全確認、masaのカメラ検証、シル子の反復練習まで本編へ入れ、『準備した大人だからできる』ことを動画の一部にした。",
      ...
      choice("ch3_08_safety_replace", "高所案を捨て、頭脳鬼ごっこへ変える", [
        "ダーマンが会場の仕掛けをルールへ変え、ヒカキンはビートを開始合図へ組み込んだ。ウダホの力、もとけの子供目線も生き、派手な落下なしで家でも遊べる企画になる。",
  ...
  ch3({
    ...
    location: "閉園後の遊園地",
    body: [
      "漁師たちとの夜間鬼ごっこで、制作側は立入禁止区域まで使う案を出した。ザ顔は許可の曖昧さを指摘し、masaの会場図にも境界線が引かれているが、そこへ入る映像なら大きく伸びるという。",
      "シル子は自分なら走り切れると知っている。それでも六人と視聴者を背負い、共同出演者のヒカキンへ最後の判断を求めた。勢いのある現場ほど、止める人間は空気を壊す役になる。"
    ],
    choices: [
  ...
  ch3({
    ...
    location: "巨大アスレチック",
    body: [
      "六人組YouTuber『漁師たち』は、アスレチックや鬼ごっこで子供たちの人気を集めていた。赤のシル子が先頭を走り、黄色のウダホが力仕事、青のmasaが技術、黒のザ顔が安全、紫のダーマンが作戦、桃色のもとけが子供の目線を担う。",
      "過去最大の会場で、ヒカキンは六人の得意を一本へまとめる共同制作者になった。迫力を優先する案と、子供が真似できる遊びへ変える案が並ぶ。"
    ],
    choices: [
      choice("ch3_08_chase_family", "親子参加型の安全な鬼ごっこにする", [
        "ヒカキンは、もとけが子供と遊ぶ様子から着想し、音当てや隠し道具で小さな子も活躍できるルールを提案した。自分のビートを開始合図に使う。",
      ...
      choice("ch3_08_chase_pro", "安全チームを雇い、本格アスレチックに挑む", [
        "ヒカキンは予算を監修者と救護班へ回し、ザ顔とmasaの確認、シル子の練習映像まで見せた。費用は膨らんだが、迫力と責任を両立した一本になる。",
  ...
  ch3({
    ...
    choices: [
      choice("ch3_09_rise_warn", "成功と敬意は別だとその場で伝える", [
        "ヒカキンはスタッフの前で怒鳴り返さず、二人になった場所で声のトーンを落とした。『いや、それはさすがにやめてください』。人格ではなく具体的な言動を挙げ、共演条件として改善を求める。",
